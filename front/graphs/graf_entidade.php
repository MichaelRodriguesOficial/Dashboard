...
<html>
<head>
<title> <?php echo $entidade_user; ?> - <?php echo __('Charts','dashboard'). " " . __('by Entity','dashboard'); ?></title>
...
} elseif (isset($_GET["sel_ent"])) {
    $id_ent = $_GET["sel_ent"];
} else {

    $id_ent = 0; // Valor padrão (altere para o valor desejado)
}
