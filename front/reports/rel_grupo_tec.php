...
if(!isset($_POST["sel_group"])) {
	$id_grp = $_REQUEST["sel_group"] ?? null;
}

else {
	$id_grp = $_POST["sel_group"] ?? null;
}
...
<html>
<head>
<title> <?php echo $entidade_user; ?> - <?php echo __('Tickets', 'dashboard').'  '. __('by Group', 'dashboard') ?> </title>
...
<table class='fluid'  style='width:100%; font-size: 18px; font-weight:bold;' cellpadding = 1px>
		...
		<div class='progress' style='margin-top: 19px;'>
			<div class='progress-bar ". $cor ." ' role='progressbar' aria-valuenow='".$barra."' aria-valuemin='1' aria-valuemax='100' style='width: ".$barra."%;'>
