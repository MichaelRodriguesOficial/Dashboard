...
<html> 
<head>
<title> <?php echo $entidade_user; ?> - <?php echo __('Charts','dashboard'). " " . __('by Technician','dashboard'); ?></title>
...
?>
		...
		<script type="text/javascript" >
			...
			<div id="graf_tipo_" class="col-md-6 col-sm-6" style="height: 450px; margin-top:30px; margin-bottom:0px; margin-left: 0px;">
				<?php include ("./inc/grafpie_tipo_.inc.php");  ?>
			</div>			
			...
			<div id="graf_time" class="col-md-12 col-sm-12" style="height: 450px; margin-top:0px !important; margin-bottom:30px; margin-left: 0px;">
