...
if(!isset($_POST["sel_tec"])) {
    $id_tec = $_GET["sel_tec"] ?? null;
}

else {
    $id_tec = $_POST["sel_tec"] ?? null;
}
...
<html>
<head>
<title> <?php echo $entidade_user; ?> - <?php echo __('Tickets','dashboard') .'  '. __('by Technician','dashboard') ?> </title>
...
if($con == "1") {
	...
	$abertos = isset($data_ab['total']) ? $data_ab['total'] : 0;
