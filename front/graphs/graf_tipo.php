...
<html> 
<head>
<title> <?php echo $entidade_user; ?> - <?php echo __('Charts','dashboard'). " " . __('by Type','dashboard'); ?></title>
...
<?php
				...
				echo '<div id="name"  style="margin-top: 15px;"><span class="total_tech"> '.$type.' - '.$total['total'].' '.__('Tickets','dashboard').'</span></div>
...
<div id="graf_tipo_" class="col-md-6 col-sm-6" style="height: 450px; margin-top:30px; margin-left: 0px;">
	<?php include ("./inc/grafpie_tipo_tipo.inc.php");  ?>
</div>
...
<div id="graf_time" class="col-md-12 col-sm-12" style="height: 450px; margin-top:30px; margin-bottom:30px; margin-left: 0px;">
	<?php include ("./inc/grafbar_age_tipo.inc.php");  ?>
</div>

<div id="graf_user_" class="col-md-6 col-sm-6" style="margin-left: 0%;">
	<?php  include ("./inc/grafbar_user_.inc.php"); ?>
</div>

<div id="graf_user" class="col-md-6 col-sm-6" style="margin-left: 0%;">
