...
<html>
<head>
    <title> <?php echo $ent_name1; ?> - Dashboard - Home</title>
                ...
                <nav class="navbar navbar-default nav-delighted navbar-fixed-top shad2" role="navigation" >
					...
					<div>
						...
						<ul id="navbar-left" class="nav navbar-nav pull-left hidden-xs">
							<li class="">
								<a href="./index.php" style="margin-top:6px; background-color: transparent; color: #FFF; padding: 10px 15px; border-radius: 5px; display: inline-block; text-decoration: none;">
									<span class="name" style="font-size: 14pt;">
										<i class="fa fa-area-chart" style="margin-right: 5px;"></i> <!-- Substitua "fas fa-home" pelo ícone desejado -->
										<?php echo $ent_name; ?>
									</span>
								</a>
							</li>
                            ...
                            <div class="sidebar-holder">
                                ...
                                <div class="user-menu">
									...
									<div class="user-info">
										...
										<div class="username">
											<a href="<?php echo $CFG_GLPI['url_base']; ?>/front/central.php" onclick="openInSameFrame(event)"><?php echo $_SESSION["glpifirstname"]." ".$_SESSION["glpirealname"];?></a>
										</div>
									</div>                                  
								</div>

								<script>
								function openInSameFrame(event) {
								  event.preventDefault(); // Evita o comportamento padrão de abrir um link

								  var url = event.target.href;
								  window.location.href = url; // Redireciona para a URL no mesmo quadro
								  scrollWin(); // Rolagem, se necessário
								}
								</script>
                                    ...
                                    <!--<li>
                                       ...
                                       <!-- <li>
                                        ...
                                        <li>
											...
											<li class='submenu'>
			                                    <a class='dropdown' onClick='return false;' href='#' data-original-title='SLAs'>
			                                        <i class='fa fa-angle-right'></i>
			                                        <span class='hidden-minibar'><?php echo __('SLA');?>
			                                            <i class='fa fa-angle-right  pull-right'></i>
			                                        </span>
			                                    </a>
			                                   <ul  class="animated fadeInDown menu2">
			                                      <li>
		                                            <a href="#" onclick="window.open('./reports/rel_sltsas.php?con=1','iframe1'); scrollWin();"  data-original-title=' SLA'>
		                                                <i class="fa fa-angle-right"></i>
		                                                <span class='hidden-minibar'> <?php echo __('Atendimento','dashboard'); ?> </span>
		                                            </a>
		                                        </li>
	   	                                     <li>
		                                            <a href="#" onclick="window.open('./reports/rel_sltsa.php','iframe1'); scrollWin();"  data-original-title=' SLA'>
		                                                <i class="fa fa-angle-right"></i>
		                                                <span class='hidden-minibar'> <?php echo __('Atendimento / Filtro','dashboard'); ?> </span>
		                                            </a>
		                                        </li> 		                                         
		                                        <li>
		                                            <a href="#" onclick="window.open('./reports/rel_sltsrs.php?con=1','iframe1'); scrollWin();"  data-original-title=' SLA'>
		                                                <i class="fa fa-angle-right"></i>
		                                                <span class='hidden-minibar'> <?php echo __('Solução','dashboard'); ?> </span>
		                                            </a>
		                                         </li> 
						        							 <li>
		                                           <a href="#" onclick="window.open('./reports/rel_sltsr.php','iframe1'); scrollWin();"  data-original-title=' SLA'>
		                                                <i class="fa fa-angle-right"></i>
		                                                <span class='hidden-minibar'> <?php echo __('Solução / Filtro','dashboard'); ?> </span>
		                                            </a>
		                                        </li> 		                                         
		                                      </ul>
		                                  </li>
										  ...
										  <li class='submenu'>
			                                    <a class='dropdown' onClick='return false;' href='#' data-original-title='OLAs'>
			                                        <i class='fa fa-angle-right'></i>
			                                        <span class='hidden-minibar'><?php echo __('OLA');?>
			                                            <i class='fa fa-angle-right  pull-right'></i>
			                                        </span>
			                                    </a>
			                                   <ul  class="animated fadeInDown menu2">
			                                      <li>
		                                            <a href="#" onclick="window.open('./reports/rel_oltsas.php?con=1','iframe1'); scrollWin();"  data-original-title=' OLA'>
		                                                <i class="fa fa-angle-right"></i>
		                                                <span class='hidden-minibar'> <?php echo __('Atendimento','dashboard'); ?> </span>
		                                            </a>
		                                        </li>
												<li>
		                                            <a href="#" onclick="window.open('./reports/rel_oltsa.php','iframe1'); scrollWin();"  data-original-title=' OLA'>
		                                                <i class="fa fa-angle-right"></i>
		                                                <span class='hidden-minibar'> <?php echo __('Atendimento / Filtro','dashboard'); ?> </span>
		                                            </a>
		                                        </li> 		                                         
		                                        <li>
		                                            <a href="#" onclick="window.open('./reports/rel_oltsrs.php?con=1','iframe1'); scrollWin();"  data-original-title=' OLA'>
		                                                <i class="fa fa-angle-right"></i>
		                                                <span class='hidden-minibar'> <?php echo __('Solução','dashboard'); ?> </span>
		                                            </a>
		                                         </li> 
						        							 <li>
		                                           <a href="#" onclick="window.open('./reports/rel_oltsr.php','iframe1'); scrollWin();"  data-original-title=' OLA'>
		                                                <i class="fa fa-angle-right"></i>
		                                                <span class='hidden-minibar'> <?php echo __('Solução / Filtro','dashboard'); ?> </span>
		                                            </a>
		                                        </li> 		                                         
                                ...
                                <li class='submenu'>
                                    ...
                                    <ul  class="animated fadeInDown">
                                      ...
                                      <!--  <li>
										...
										<li class='submenu'>
											<a class='dropdown' onClick='return false;' href='#' data-original-title='SLA'>
												<i class="fa fa-angle-right"></i>
													<span class='hidden-minibar'><?php echo __('SLA','dashboard'); ?>
														<i class='fa fa-chevron-right  pull-right'></i>
													</span>
											</a>
											<ul  class="animated fadeInDown">
										...
										<li class='submenu'>
											<a class='dropdown' onClick='return false;' href='#' data-original-title='OLA'>
												<i class="fa fa-angle-right"></i>
													<span class='hidden-minibar'><?php echo __('OLA','dashboard'); ?>
														<i class='fa fa-chevron-right  pull-right'></i>
													</span>
											</a>
											<ul  class="animated fadeInDown">
												<li>
		                                            <a href="#" onclick="window.open('./graphs/oltsa.php','iframe1'); scrollWin();"  data-original-title=' OLA'>
		                                                <i class="fa fa-angle-right"></i>
		                                                <span class='hidden-minibar'> <?php echo __('Atendimento','dashboard'); ?> </span>
		                                            </a>
		                                        </li> 		                                         
		                                        <li>
		                                            <a href="#" onclick="window.open('./graphs/oltsr.php','iframe1'); scrollWin();"  data-original-title=' OLA'>
		                                                <i class="fa fa-angle-right"></i>
		                                                <span class='hidden-minibar'> <?php echo __('Solução','dashboard'); ?> </span>
		                                            </a>
		                                        </li>
