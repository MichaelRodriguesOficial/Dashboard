...
$id_grupo = $id_grp; // ID do grupo desejado

if (isset($arr_grp[$id_grupo])) {
    $nome_grupo = $arr_grp[$id_grupo];
} else {
    $nome_grupo = 'Geral';
}
...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <meta charset="utf-8">
    <title> <?php echo $entidade_user; ?> -  <?php echo __('Metrics','dashboard'); ?></title>
		...
		<div style="" class="col-lg-3 cf-item">
			...
			<div class="content">
				...
				<!-- <div class="cf-td cf-td-12"> -->
					<div class="cf-version metric-small" style="font-size:30px !important;"><?php echo $entidade_user . ' - ' . $nome_grupo ?></div>
