...
$query3 = "
SELECT count( glpi_tickets.id ) AS conta, glpi_tickets.".$olaid." AS id, glpi_olas.name
...
$porcentagem = array();
foreach ($quant3 as $valor) {
    $porcentagem[] = round(($valor / $soma3) * 100, 1);
}
                ...
                bar: {
                    dataLabels: {
                        ...
                        formatter: function() {
                            ...
                            var valor = this.y;
                            var porcentagem = ".json_encode($porcentagem).";
                            return valor + ' = ' + porcentagem[index] + '%';
                        },
                        align: 'right',
                        inside: true
                    },
