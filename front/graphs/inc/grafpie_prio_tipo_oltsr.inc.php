...
$query2 = "
SELECT COUNT(glpi_tickets.id) as tick, (glpi_tickets.olas_id_ttr) AS total, glpi_tickets.".$olaid." AS id, glpi_olas.name, glpi_tickets.priority AS prio
