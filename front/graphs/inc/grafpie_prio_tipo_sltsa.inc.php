...
$query2 = "
SELECT COUNT(glpi_tickets.id) as tick, (glpi_tickets.slas_id_tto) AS total, glpi_tickets.".$slaid." AS id, glpi_slas.name, glpi_tickets.priority AS prio
