...
<html> 
<head>
<title> <?php echo $entidade_user; ?> - <?php echo __('Tickets', 'dashboard') ?> </title>
...
if($consulta > 0) {
	...
	echo "	
		<tr style='font-weight:normal;'>
			...
			<td style='vertical-align:middle;'> ". (isset($row_user['title']) ? substr($row_user['title'],0,55) : '') ." </td>
			<td style='vertical-align:middle; max-width:550px;'> ". (isset($row_user['content']) ? html_entity_decode($row_user['content']) : '') ." </td>
			<td style='vertical-align:middle;'> ". $row_user['name'] ." ".$row_user['sname'] ." </td>
			<td style='vertical-align:middle;'> ". $row_tec['name'] ." ".$row_tec['sname'] ." ".$row_for['fname'] ." </td>
