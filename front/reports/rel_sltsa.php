...
elseif (isset($_GET['sel_sla'])) {
	$id_sla = $_GET['sel_sla'];
} 
else {
	$id_sla = null; // ou outra ação, como lançar um erro ou redirecionar o usuário
}
...
<html>
<head>
<title> <?php echo $entidade_user; ?> - <?php echo __('Tickets') .'  '. __('by SLA', 'dashboard') ?> </title>
