...
elseif (isset($_GET['sel_ola'])) {
	$id_ola = $_GET['sel_ola'];
} 
else {
	$id_ola = null; // ou outra ação, como lançar um erro ou redirecionar o usuário
}
...
<html>
<head>
<title> <?php echo $entidade_user; ?> - <?php echo __('Tickets') .'  '. __('by OLA', 'dashboard') ?> </title>
