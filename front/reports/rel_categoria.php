...
if(!isset($_POST["sel_cat"])) {
	$id_cat = $_GET["sel_cat"] ?? null;
}

else {
	$id_cat = $_POST["sel_cat"] ?? null;
}
...
<html>
<head>
<title> <?php echo $entidade_user; ?> - <?php echo __('Tickets', 'dashboard') .'  '. __('by Category', 'dashboard') ?> </title>
...
<div id='content' >
	<div id='container-fluid' style="margin: <?php echo margins(); ?> ;">
		<div id="charts" class="fluid chart">
			...
			$and_sons = ''; // Inicialização padrão como uma string vazia
			...
			<span  style='font-size: 16px; font-weight:bold; vertical-align:middle;'><span style='color:#000;'> ".__('Category').": </span>".(!empty($cat_name['name']) ? $cat_name['name'] : '').$and_sons." </span>	
