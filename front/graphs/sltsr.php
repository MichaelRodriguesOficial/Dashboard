		...
		<div id="charts" class="fluid chart"> 
			...
			<?php
				...
				$datas = "BETWEEN '".$data_ini." 00:00:00' AND '".$data_fin." 23:59:59'";
					...
					$query_total = "
					SELECT COUNT(slas_id_ttr) AS total, glpi_tickets.".$slaid." AS id, glpi_slas.name
			...
			<div id="graf_tipo_grupo_sltsr" class="col-md-6" style="margin-left: 15px">
				<?php  include ("./inc/grafpie_tipo_grupo_sltsr.inc.php"); ?>
			</div>
			
			<div id="graf_prio_sltsr" class="col-md-6" style="margin-left: -15px">
				<?php include ("./inc/grafpie_prio_tipo_sltsr.inc.php");  ?>
			</div>
