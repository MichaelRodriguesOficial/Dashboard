    ...
    <div class="navbar yamm navbar-default nav-delighted" id="menuHeader"> 
		...
		<ul class="nav navbar-nav">
			...
			<li class="dropdown menu">
				<?php
				echo '<img src="'. $photo_url .'" alt="" title="Upload photo in user profile" class="avatar" style="width: 55px; height: 55px; margin-left: 0px; " />&nbsp;&nbsp;';
				?>	
			</li>

			<li class="dropdown menu">
			  <a href="<?php echo $CFG_GLPI['url_base']; ?>/front/central.php" style="color:#fff;">
				<?php
				  echo $_SESSION["glpifirstname"]." ".$_SESSION["glpirealname"];
				?>
			  </a>
			</li>
          ...
          <li class="dropdown menu"><a href="#" data-toggle="dropdown" class="dropdown-toggle" style="color:#fff;"><span c onclick="location.href=('index.php')"><i class='fa fa-dashboard'></i>&nbsp; Dashboard</span></a></li>
		  <li class="dropdown menu"><a href="#" data-toggle="dropdown" class="dropdown-toggle" style="color:#fff;"><span class="text-nav1" onclick="window.open('./graphs/graf_tech.php?con=1','iframe1');"><i class='fa fa-area-chart'></i>&nbsp; <?php echo __('My Dashboard','dashboard');?></span></a></li>
           ...
           <!-- Classic dropdown -->            
			...
			<li class="dropdown menu"><a href="#" data-toggle="dropdown" class="dropdown-toggle" style="color:#fff;"><span class="text-nav1"><i class='fa fa-line-chart'></i>&nbsp;<?php echo __('Metrics','dashboard');?>&nbsp;<b class="caret"></b></span></a>
              <ul role="menu" class="dropdown-menu">
                <li><a tabindex="-1" href="./metrics/index.php" target=""> <?php echo __('Overall','dashboard'); ?> </a></li>
                <!--<li><a tabindex="-1" href="./metrics/select_ent.php" target=""> <?php echo __('by Entity','dashboard'); ?> </a></li>-->
                <li><a tabindex="-1" href="./metrics/select_grupo.php" target="">  <?php echo __('by Group','dashboard'); ?> </a></li>                
              </ul>			
			</li>			
