...
<html> 
<head>
<title> <?php echo $entidade_user; ?> - <?php echo __('Tickets','dashboard') .'  '. __('by OLA','dashboard').'s'  ?></title>
		...
		<div id="charts" class="fluid chart"> 
							...
							<table border="0" cellspacing="0" cellpadding="0">
								...
								<tr align="center">
									<td>
										...
										<button class="btn btn-primary btn-sm" type="button" name="Limpar" value="Limpar" onclick="location.href='oltsa.php'" ><i class="fa fa-trash-o"></i>&nbsp; <?php echo __('Clean','dashboard'); ?> </button>
									</td>
								</tr>
							</table>
						<p>
			...
			<?php
				...
				$datas = "BETWEEN '".$data_ini." 00:00:00' AND '".$data_fin." 23:59:59'";
					...
					$query_total = "
					SELECT COUNT(olas_id_tto) AS total, glpi_tickets.".$olaid." AS id, glpi_olas.name
			...
			<div id="graf_tipo_grupo_oltsa" class="col-md-6" style="margin-left: 15px">
				<?php  include ("./inc/grafpie_tipo_grupo_oltsa.inc.php"); ?>
			</div>
			
			<div id="graf_prio_oltsa" class="col-md-6" style="margin-left: -15px">
				<?php include ("./inc/grafpie_prio_tipo_oltsa.inc.php");  ?>
			</div>
