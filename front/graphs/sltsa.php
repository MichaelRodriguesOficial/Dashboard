...
<html> 
<head>
<title> <?php echo $entidade_user; ?> - <?php echo __('Tickets','dashboard') .'  '. __('by SLA','dashboard').'s'  ?></title>
		...
		<div id="charts" class="fluid chart"> 
			...
			<?php
				...
				$datas = "BETWEEN '".$data_ini." 00:00:00' AND '".$data_fin." 23:59:59'";
					...
					$query_total = "
					SELECT COUNT(slas_id_tto) AS total, glpi_tickets.".$slaid." AS id, glpi_slas.name
			...
			<div id="graf_tipo_grupo_sltsa" class="col-md-6" style="margin-left: 15px">
				<?php  include ("./inc/grafpie_tipo_grupo_sltsa.inc.php"); ?>
			</div>
			
			<div id="graf_prio_sltsa" class="col-md-6" style="margin-left: -15px">
				<?php include ("./inc/grafpie_prio_tipo_sltsa.inc.php");  ?>
			</div>
